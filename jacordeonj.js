...
const datos = [
  {
    ...
    imagen: 'https://www.clinicaveterinariamh.com/wp-content/uploads/2023/08/45.jpg',
    descripcion: 'Higiene y estética profesional para tu mascota.',
    precio: 'B/. 15.00'
  },
  {
    titulo: 'Adiestramiento',
    imagen: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1fL23Fk7sk5aCZAFALgME1FGE3IYuNmS3OQ&s',
    descripcion: 'Obediencia, socialización y control de conducta.',
    precio: 'B/. 25.00'
  },
  {
    titulo: 'Veterinaria',
    imagen: 'https://purina.com.pa/sites/default/files/2022-10/purina-consulta-veterinaria-para-mascotas-lo-que-debes-saber.jpg',
